...
public:
    ...
    void set_base_currency(fiat_currency_t base_currency) { base_currency_ = base_currency; }
};
...
private:
    ...
    static std::chrono::high_resolution_clock::time_point last_request_time_;
public:
